...
Turn an iterator into a lender with [`into_lender`](https://docs.rs/lender/latest/lender/trait.IteratorExt.html#tymethod.into_lender), which is just a pass-through, or
