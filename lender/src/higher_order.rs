...
/// Higher-Rank Closure (FnOnce) macro that replaces the `closure_lifetime_binder` feature for
/// stable.
///
...
/// Higher-Rank Closure (FnMut) macro that replaces the `closure_lifetime_binder` feature for
/// stable.
///
/// This is a modified version of
/// [`higher-order-closure`](https://crates.io/crates/higher-order-closure)'s
