...
use crate::{FallibleLend, FallibleLender, FallibleLending, FalliblePeekable};
    ...
    L: FallibleLender,
{
    ...
    pub fn into_parts(self) -> (L, FallibleLend<'this, L>) { (self.lender.into_inner(), self.separator) }
}
