...
impl<I: FallibleIterator> FallibleIteratorExt<I> for I {
    fn into_fallible_lender(self) -> FromFallibleIter<I> { crate::from_fallible_iter(self) }
}
...
impl<I: IntoFallibleIterator> IntoFallibleIteratorExt<I> for I {
    fn into_into_fallible_lender(self) -> FromIntoFallibleIter<I> { crate::from_into_fallible_iter(self) }
}
